...
* Open-air burning pollutes the atmosphere. Instead, we chose to use a contained box in which to burn our recycled vines. The process not only reduced emissions but also created biochar which sequesters carbon and provided compost.
* Our sparse, strategic irrigations foster deep vine roots and resilient vines.
* Each vine is pruned individually to produce only the amount of grapes that it can reasonably fully nurture to maturity.
* Our farming has been completely organic since 2008, meaning zero harmful chemicals and as much hand work as possible. In 2023 we were awarded organic certification by the CCOF.
...
* During winery construction, we chose to locate our barrel cellar underground to reduce the need for man-made cooling and reduce our footprint.
