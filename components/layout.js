...
export default function Layout({ home, discover, wine, purchase, visit, membership, faq, contact, join, checkout, account, credits, dispatch, privacy, blog, blog_post, children, props, data }) {
        ...
        <div className="desktop-navigation">
          <div className={seenAnimation ? "navigation" : "navigation animated"}>
                      ...
                      <div className="account-nav desktop-only logged-in">
                        {accountNavItemsLoggedIn
                          .map((navItem, index) => {
                            ...
                            return <a className={router.asPath === (navItem.url || (navItem.url + '/') || '/profile' || '/profile/login' || '/profile/' || '/profile/[id]' || '/profile/order-history' || '/profile/account/address') ? 'c7-btn active' : 'c7-btn'} key={index} href={navItem.url}><span>{navItem.title}</span></a>
                          }
                          )}
            ...
            <nav className="mobile-only">
              ...
              <a href="/privacy"><span>Privacy & Terms</span></a>
        ...
        <>
          ...
          <div className='navigation desktop-only'>
            <nav>
              ...
              <a href="/privacy" className={privacy && 'active'}><span>Privacy & Terms</span></a>
