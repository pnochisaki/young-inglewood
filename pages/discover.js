    ...
    <Layout>
      <>
        ...
        <section className='farm'>
          <div className='farm-1' style={{ backgroundImage: `url(/images/farm-1.jpg)` }} />
          <h2>Farm</h2>
          ...
          <div className='farm-2' style={{ backgroundImage: `url(/images/farm-2.jpg)` }} />
        ...
        <section className='cellar'>
          <div className='cellar-1' style={{ backgroundImage: `url(/images/cellar-1.jpg)` }} />
          <h2>Cellar</h2>
          ...
          <div className='cellar-2' style={{ backgroundImage: `url(/images/cellar-2.jpg)` }} />
        ...
        <section className='team'>
          <div className='team-1' style={{ backgroundImage: `url(/images/team-1.jpg)` }} />
          <h2>Team</h2>
