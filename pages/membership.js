      ...
      <Layout membership data={markdown}>
        ...
        {markdown.headline &&
          ...
          <Section
            ...
            text2="<p>Choose from a range of memberships.  Our team will be delighted to help you customize your FYI membership to suit your taste, so you’ll always get just what you want.</p>
          ...
          <div dangerouslySetInnerHTML={{ __html: markdown.contentHtml }} />
            ...
            <div className="table">
              ...
              {memberships
                ...
                .sort((a, b) => Date(a.updatedAt) - Date(b.updatedAt))
                .map((club, index) => {
                  return <div
                    key={club.slug}
                    id={club.slug}
