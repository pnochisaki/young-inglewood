    ...
    <>
      ...
      <Layout wine data={markdownData}>
        <>
          ...
          <br><a class='button-shadow' href='${markdownData.varietal_link_1}'>${markdownData.varietal_link_1_text}</a></p>
          <p>Delicately colored, crisp and refreshing, our Vin Clair Rosé shows the lighter side of Malbec and Merlot.
          <br><a class='button-shadow' href='${markdownData.varietal_link_2}'>${markdownData.varietal_link_2_text}</a></p>
          ...
          <br><a class='button-shadow' href='${markdownData.varietal_link_3}'>${markdownData.varietal_link_3_text}</a></p>
          `}
          />
          ...
          <Section
            ...
            text2="<p>The idea came out of a simple question: how does the philosophy of old school Napa Cabernet intersect our modern approachable wine making culture? This label is filled with interesting whites and reds. Check it out:<br><a class='button-shadow' href='https://venn.wine' target='_blank'>Venn.wine</a></p>"
          />
